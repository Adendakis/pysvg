...
def createShapes():
    ...
    elements.append(r)
    r = oh.createRect(
        120, 70, 80, 30, strokewidth='2px', stroke='#00C', fill='#FFC')
    elements.append(r)
    ...
    elements.append(c)
    c = oh.createCircle(
        150, 170, 30, strokewidth='2px', stroke='#000', fill='#FF0')
    elements.append(c)
    ...
    elements.append(e)
    e = oh.createEllipse(
        150, 270, 30, 15, strokewidth='2px', stroke='#000', fill='#CCC')
    elements.append(e)

    # polygon
    p = oh.createPolygon('60,370, 70,360, 80,400, 50,440, 40,330',
                         strokewidth='2px', stroke='#000', fill='#FFF')
    elements.append(p)
    ...
    # polyline
    p = oh.createPolyline(
        '250,325 200,345 250,365', strokewidth='2px', stroke='#090')
    elements.append(p)
    ...
    r = oh.createRect(620, 500, width='100', height='50', rx=10,
...
def createDefs():
    ...
    p = pysvg.Pattern(0, 0, 20, 20, "userSpaceOnUse")
    p.set_id("muster1")

    r = pysvg.Rect(0, 0, 10, 10)
