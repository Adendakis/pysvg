...
'''
from attributes import ExternalAttrib, MarkerAttrib
from core import BaseElement, BaseShape, PointAttrib, DimensionAttrib,\
                 PointToAttrib
...
class Rect(BaseShape, PointAttrib, DimensionAttrib):
    ...
    """
    def __init__(self, x=None, y=None, width=None, height=None, rx=None,
                 ry=None, **kwargs):
    ...
    # extra methods. Methods do rely on number values in the attributes.
    # You might get an exception else!
    def getEdgePoints(self):
        """
        Returns a list with the coordinates of the points at the edge of the
        rectangle as tuples. e.g.[(x1,y1),(x2,y2)]
        ...
        result.append((float(self.get_x())+float(self.get_width()),
                       float(self.get_y())))
        result.append((float(self.get_x())+float(self.get_width()),
                       float(self.get_y())+float(self.get_height())))
        result.append((float(self.get_x()),
                       float(self.get_y())+float(self.get_height())))
        return result

    def getInnerEdgePoints(self):
        """
        Returns a list with the coordinates of the points at the inner edge of
         a rounded rectangle as tuples. e.g.[(x1,y1),(x2,y2)]
        The sorting is counterclockwise starting with the lower left corner.
        Coordinates must be numbers or an exception will be thrown.
        """
        result = []
        result.append((float(self.get_x()) + float(self.get_rx()),
    ...
    def getBottomLeft(self):
        """
        Retrieves a tuple with the x,y coordinates of the lower left
        point of the rect.
    ...
    def getBottomRight(self):
        """
        Retrieves a tuple with the x,y coordinates of the lower right
        point of the rect.
        Requires the coordinates, width, height to be numbers
        """
        return (float(self.get_x()) + float(self.get_width()),
                float(self.get_y()))

    def getTopLeft(self):
        """
        Retrieves a tuple with the x,y coordinates of the upper left
        point of the rect.
        Requires the coordinates, width, height to be numbers
        """
        return (float(self.get_x()), float(self.get_y()) +
    ...
    def getTopRight(self):
        """
        Retrieves a tuple with the x,y coordinates of the upper
        right point of the rect.
        Requires the coordinates, width, height to be numbers
        """
        return (float(self.get_x()) + float(self.get_width()),
                float(self.get_y()) + float(self.get_height()))
...
class Circle(BaseShape):
    ...
    def getDiameter(self):
        """
        Retrieves the diameter of the circle.
        Requires the radius to be a number.
        """
    ...
    def getBottomLeft(self):
        """
        Retrieves a tuple with the x,y coordinates of the lower left point
        of the circle.
        Requires the radius and the coordinates to be numbers
        """
        return (float(self.get_cx()) - float(self.get_r()),
...
class Ellipse(BaseShape):
    ...
    def getBottomLeft(self):
        """
        Retrieves a tuple with the x,y coordinates of the lower left point of
        the ellipse.
        Requires the radius and the coordinates to be numbers
        """
        return (float(self.get_cx()) - float(self.get_rx()),
    ...
    def getTopRight(self):
        """
        Retrieves a tuple with the x,y coordinates of the upper right
        point of the ellipse.
        Requires the radius and the coordinates to be numbers
        """
        return (float(self.get_cx()) + float(self.get_rx()),
...
class Path(BaseShape, ExternalAttrib, MarkerAttrib):
    ...
    def __init__(self, pathData="", pathLength=None,
                 style=None, focusable=None, **kwargs):
    ...
    def appendCubicCurveToPath(self, controlstartx, controlstarty, controlendx,
                               controlendy, endx, endy, relative=True):
        self.__append__('c', [controlstartx, controlstarty, controlendx,
                              controlendy, endx, endy], relative)

    def appendCubicShorthandCurveToPath(self,  controlendx, controlendy,
                                        endx, endy, relative=True):
        self.__append__('s', [controlendx, controlendy, endx, endy], relative)

    def appendQuadraticCurveToPath(self, controlx, controly, endx,
                                   endy, relative=True):
    ...
    def appendArcToPath(self, rx, ry, x, y, x_axis_rotation=0,
                        large_arc_flag=0, sweep_flag=1, relative=True):
        self.__append__('a', [rx, ry, x_axis_rotation, large_arc_flag,
                              sweep_flag, x, y], relative)
