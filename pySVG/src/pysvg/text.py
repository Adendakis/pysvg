...
'''
from attributes import CoreAttrib, ExternalAttrib, StyleAttrib, FontAttrib,\
                       XLinkAttrib, PaintAttrib, ConditionalAttrib,\
                       GraphicalEventsAttrib, OpacityAttrib, GraphicsAttrib,\
                       CursorAttrib, FilterAttrib, MaskAttrib, ClipAttrib,\
                       TextContentAttrib, TextAttrib
...
class GlyphRef(BaseElement, CoreAttrib, ExternalAttrib, StyleAttrib,
               FontAttrib, XLinkAttrib, PaintAttrib, PointAttrib,
               DeltaPointAttrib):
    """
    ...
    def set_format(self, aFormat):
        self._attributes['format'] = aFormat
...
class AltGlyph(GlyphRef, ConditionalAttrib, GraphicalEventsAttrib,
               OpacityAttrib, GraphicsAttrib, CursorAttrib, FilterAttrib,
               MaskAttrib, ClipAttrib, TextContentAttrib, RotateAttrib):
    """
...
class TextPath(BaseElement, CoreAttrib, ConditionalAttrib, ExternalAttrib,
               StyleAttrib, XLinkAttrib, FontAttrib, PaintAttrib,
               GraphicalEventsAttrib, OpacityAttrib, GraphicsAttrib,
               CursorAttrib, FilterAttrib, MaskAttrib, ClipAttrib,
               TextContentAttrib):
    """
...
class Tref(BaseElement, CoreAttrib, ConditionalAttrib, ExternalAttrib,
           StyleAttrib, XLinkAttrib, PointAttrib, DeltaPointAttrib,
           RotateAttrib, GraphicalEventsAttrib, PaintAttrib, FontAttrib,
           OpacityAttrib, GraphicsAttrib, CursorAttrib, FilterAttrib,
           MaskAttrib, ClipAttrib, TextContentAttrib):
    """
...
class Tspan(BaseElement, CoreAttrib, ConditionalAttrib, ExternalAttrib,
            StyleAttrib, PointAttrib, DeltaPointAttrib, RotateAttrib,
            GraphicalEventsAttrib, PaintAttrib, FontAttrib, OpacityAttrib,
            GraphicsAttrib, CursorAttrib, FilterAttrib, MaskAttrib, ClipAttrib,
            TextContentAttrib):
    """
    Class representing the tspan element of an svg doc.
    """
    def __init__(self, x=None, y=None, dx=None, dy=None, rotate=None,
                 textLength=None, lengthAdjust=None, **kwargs):
...
class Text(BaseElement, CoreAttrib, ConditionalAttrib, ExternalAttrib,
           StyleAttrib, PointAttrib, DeltaPointAttrib, RotateAttrib,
           GraphicalEventsAttrib, PaintAttrib, FontAttrib, OpacityAttrib,
           GraphicsAttrib, CursorAttrib, FilterAttrib, MaskAttrib, ClipAttrib,
           TextContentAttrib, TextAttrib):
    ...
    """
    def __init__(self, content=None, x=None, y=None, dx=None, dy=None,
                 rotate=None, textLength=None, lengthAdjust=None, **kwargs):
