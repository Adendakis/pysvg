...
class CoreAttrib:
    ...
    """
    def set_id(self, idattr):
        self._attributes['id'] = idattr
...
class GraphicalEventsAttrib:
    """
    The GraphicalEventsAttrib class defines the GraphicalEvents.attrib
     attribute set.
    """
...
class ExternalAttrib:
    ...
    """
    def set_externalResourcesRequired(self, externalResRequired):
        self._attributes['externalResourcesRequired'] = externalResRequired
...
class DocumentEventsAttrib:
    """
    The DocumentEventsAttrib class defines the DocumentEvents.attrib attribute
    set.
    """
...
class FilterAttrib:
    ...
    """
    def set_filter(self, filterattr):
        self._attributes['filter'] = filterattr
...
class FilterColorAttrib:
    ...
    def set_color_interpolation_filters(self, color_interpolation_filters):
        self._attributes['color-interpolation-filters'] = \
...
class FilterPrimitiveAttrib:
    """
    The FilterPrimitiveAttrib class defines the FilterPrimitive.attrib
     attribute sets.
    """
    def set_x(self, x):
...
class FilterPrimitiveWithInAttrib(FilterPrimitiveAttrib):
    """
    The FilterPrimitiveWithInAttrib class defines the
     FilterPrimitiveWithIn.attrib attribute sets.
    """
...
class XLinkAttrib:
    """
    The XLinkAttrib class defines the XLink.attrib, XLinkRequired.attrib,
     XLinkEmbed.attrib and XLinkReplace.attrib attribute sets.
    """
...
class TextContentAttrib:
    ...
    def set_glyph_orientation_horizontal(self, gl_ori_horiz):
        self._attributes['glyph-orientation-horizontal'] = gl_ori_horiz

    def get_glyph_orientation_horizontal(self):
        return self._attributes['glyph-orientation-horizontal']

    def set_glyph_orientation_vertical(self, gl_ori_vert):
        self._attributes['glyph-orientation-vertical'] = gl_ori_vert
...
class PresentationAttributes_Color:
    """
    The PresentationAttributes_Color class defines the
     PresentationAttributes_Color.attrib attribute set.
...
class PresentationAttributes_Containers:
    """
    The PresentationAttributes_Containers class defines the
     PresentationAttributes_Containers.attrib attribute set.
...
class PresentationAttributes_feFlood:
    """
    The PresentationAttributes_feFlood class defines the
     PresentationAttributes_feFlood.attrib attribute set.
...
class PresentationAttributes_FilterPrimitives:
    """
    The PresentationAttributes_FilterPrimitives class defines the
     PresentationAttributes_FilterPrimitives.attrib attribute set.
    The following presentation attributes apply to filter primitives
    """
    def set_color_interpolation_filters(self, c_i_filters):
        self._attributes['color-interpolation-filters'] = c_i_filters
...
class PresentationAttributes_FillStroke:
    """
    The PresentationAttributes_FillStroke class defines the
     PresentationAttributes_FillStroke.attrib attribute set.
...
class PresentationAttributes_FontSpecification(FontAttrib):
    """
    The PresentationAttributes_FontSpecification class defines the
     PresentationAttributes_FontSpecification.attrib attribute set.
    The following presentation attributes have to do with selecting a
     font to use.
    """
...
class PresentationAttributes_Gradients(GradientAttrib):
    """
    The PresentationAttributes_Gradients class defines the
     PresentationAttributes_Gradients.attrib attribute set.
    The following presentation attributes apply to gradient 'stop' elements.
    """


class PresentationAttributes_Graphics(ClipAttrib, CursorAttrib,
                                      GraphicsAttrib, MaskAttrib,
                                      FilterAttrib):
    """
    The PresentationAttributes_Graphics class defines the
     PresentationAttributes_Graphics.attrib attribute set.
...
class PresentationAttributes_Images:
    """
    The PresentationAttributes_Images class defines the
     PresentationAttributes_Images.attrib attribute set.
...
class PresentationAttributes_LightingEffects:
    """
    The PresentationAttributes_LightingEffects class defines the
     PresentationAttributes_LightingEffects.attrib attribute set.
...
class PresentationAttributes_Marker(MarkerAttrib):
    """
    The PresentationAttributes_Marker class defines the
     PresentationAttributes_Marker.attrib attribute set.
...
class PresentationAttributes_TextContentElements(TextContentAttrib):
    """
    The PresentationAttributes_TextContentElements class defines the
     PresentationAttributes_TextContentElements.attrib attribute set.
...
class PresentationAttributes_All(PresentationAttributes_Color,
    ...
    """
    The PresentationAttributes_All class defines the Presentation.attrib
     attribute set.
    """
