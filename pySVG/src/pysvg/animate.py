...
'''
from pysvg.attributes import XLinkAttrib, CoreAttrib, ConditionalAttrib,\
                             ExternalAttrib
from pysvg.core import BaseShape, BaseElement
...
class AnimationAttributeAttrib:
    """
    The AnimationAttributeAttrib class defines the AnimationAttribute.attrib
    attribute set.
    """
...
class AnimationTimingAttrib:
    """
    The AnimationTimingAttrib class defines the AnimationTiming.attrib
    attribute set.
    """
    ...
    def set_min(self, minimum):
        self._attributes['min'] = minimum

    def get_min(self):
        return self._attributes.get('min')

    def set_max(self, maximum):
        self._attributes['max'] = maximum
...
class AnimationValueAttrib:
    """
    The AnimationValueAttrib class defines the AnimationValue.attrib
    attribute set.
    """
...
class AnimationAdditionAttrib:
    """
    The AnimationAdditionAttrib class defines the AnimationAddition.attrib
    attribute set.
    """
...
class AnimationEventsAttrib:
    """
    The AnimationEventsAttrib class defines the AnimationEvents.attrib
    attribute set.
    """
...
# Animation Elements
##############################################
class Animate(BaseShape, CoreAttrib, ConditionalAttrib, ExternalAttrib,
              AnimationEventsAttrib, AnimationAttrib, AnimationAttributeAttrib,
              AnimationTimingAttrib, AnimationValueAttrib,
...
class Set(BaseShape, CoreAttrib, ConditionalAttrib, ExternalAttrib,
          AnimationEventsAttrib, AnimationAttrib, AnimationAttributeAttrib,
...
class AnimateMotion(BaseShape, CoreAttrib, ConditionalAttrib, ExternalAttrib,
                    AnimationEventsAttrib, AnimationAttrib,
                    AnimationTimingAttrib, AnimationValueAttrib,
                    AnimationAdditionAttrib):
    """
...
class AnimateTransform(BaseShape, CoreAttrib, ConditionalAttrib,
                       ExternalAttrib, AnimationEventsAttrib, AnimationAttrib,
                       AnimationAttributeAttrib, AnimationTimingAttrib,
                       AnimationValueAttrib, AnimationAdditionAttrib):
    """
    ...
    def set_type(self, animtype):
        self._attributes['type'] = animtype

    def get_type(self):
        return self._attributes.get('type')


class AnimateColor(BaseShape, CoreAttrib, ConditionalAttrib, ExternalAttrib,
                   AnimationEventsAttrib, AnimationAttrib,
                   AnimationAttributeAttrib, AnimationTimingAttrib,
                   AnimationValueAttrib, AnimationAdditionAttrib):
    """
