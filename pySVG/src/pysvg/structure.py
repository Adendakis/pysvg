...
'''
from attributes import CoreAttrib, ConditionalAttrib, StyleAttrib,\
                       ViewportAttrib, PaintAttrib, OpacityAttrib,\
                       GraphicsAttrib, ClipAttrib, MaskAttrib, FilterAttrib,\
                       GraphicalEventsAttrib, CursorAttrib, XLinkAttrib,\
                       ExternalAttrib, PresentationAttributes_All,\
                       DocumentEventsAttrib
from core import BaseElement, PointAttrib, DimensionAttrib


class G(BaseElement, CoreAttrib, ConditionalAttrib, StyleAttrib,
        ExternalAttrib, PresentationAttributes_All, GraphicalEventsAttrib):
    """
...
class Symbol(BaseElement, CoreAttrib, StyleAttrib, ExternalAttrib,
             PresentationAttributes_All, GraphicalEventsAttrib):
    """
...
class Use(BaseElement, CoreAttrib, StyleAttrib, ConditionalAttrib,
          PointAttrib, DimensionAttrib, XLinkAttrib,
          PresentationAttributes_All, GraphicalEventsAttrib):
    """
...
class Svg(BaseElement, CoreAttrib, StyleAttrib, ConditionalAttrib,
          PointAttrib, DimensionAttrib, XLinkAttrib,
          PresentationAttributes_All, GraphicalEventsAttrib,
          DocumentEventsAttrib):
    """
...
class Image(BaseElement, CoreAttrib, ConditionalAttrib, StyleAttrib,
            ViewportAttrib, PaintAttrib, OpacityAttrib, GraphicsAttrib,
            ClipAttrib, MaskAttrib, FilterAttrib, GraphicalEventsAttrib,
            CursorAttrib, XLinkAttrib, ExternalAttrib, PointAttrib,
            DimensionAttrib):
    """
    Class representing the image element of an svg doc.
    """
    def __init__(self, x=None, y=None, width=None, height=None,
                 preserveAspectRatio=None, **kwargs):
...
class Switch(BaseElement, CoreAttrib, ConditionalAttrib, StyleAttrib,
             PresentationAttributes_All, GraphicalEventsAttrib,
             ExternalAttrib):
    """
...
class ClipPath(BaseElement, CoreAttrib, ConditionalAttrib, StyleAttrib,
               ExternalAttrib, PresentationAttributes_All,
               GraphicalEventsAttrib):
    """
    Class representing the clipPath element of an svg doc.
    """
    def __init__(self, anID=None, transform=None, clipPathUnits=None,
                 **kwargs):
